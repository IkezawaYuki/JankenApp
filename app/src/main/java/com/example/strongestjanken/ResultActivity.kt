...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myHand = when (id) {
            R.id.gu -> {
                myHandImage.setImageResource(R.drawable.gu_player)
                gu
            }
            R.id.choki -> {
                myHandImage.setImageResource(R.drawable.tyoki_player)
                choki
            }
            R.id.pa -> {
                myHandImage.setImageResource(R.drawable.pa_player)
                pa
            }
            else -> gu
        }
        ...
        when (comHand) {
            gu -> comHandImage.setImageResource(R.drawable.gu_com)
            choki -> comHandImage.setImageResource(R.drawable.tyoki_com)
            pa -> comHandImage.setImageResource(R.drawable.pa_com)
        }
